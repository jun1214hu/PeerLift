...
class ScholarshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post scholarships_url, params: { scholarship: { deadline: @scholarship.deadline, name: @scholarship.name } }
    end
  ...
  test "should update scholarship" do
    patch scholarship_url(@scholarship), params: { scholarship: { deadline: @scholarship.deadline, name: @scholarship.name } }
