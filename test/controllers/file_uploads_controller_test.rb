...
class FileUploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post file_uploads_url, params: { file_upload: { attachment: @file_upload.attachment, given_name: @file_upload.given_name, user_id: @file_upload.user_id } }
    end
  ...
  test "should update file_upload" do
    patch file_upload_url(@file_upload), params: { file_upload: { attachment: @file_upload.attachment, given_name: @file_upload.given_name, user_id: @file_upload.user_id } }
