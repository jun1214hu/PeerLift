...
RSpec.describe User, type: :model do
  context 'validation tests' do
    ...
    puts user.last_name
      ...
      # Since there is no first_name then it should be FALSE!
      user.first_name = nil
    ...
    it 'ensures last name presence' do
      ...
      # Since there is no last_name then it should be FALSE!
...
#   # Making sure the user has all the valid attributes
#   it "is valid with valid attributes" do
#     expect(@user1).to be_valid
#   end
  
#   # Checking the uid (instead of username since we do not have usernames) 
