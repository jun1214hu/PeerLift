class FileUploadsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @file_upload.save
        format.html { redirect_to "/file_uploads", notice: 'File upload was successfully created.' }
  ...
  private
    ...
    def file_upload_params
      #params.permit(:file_upload, :user_id, :given_name, :attachment)
      params.fetch(:file_upload, {}).permit(:file_upload, :user_id, :given_name, :attachment)
    end
end
